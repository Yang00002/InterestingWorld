...
public class TableEnchantGenerator
{
																  ...
																  MutableInt costAchieve)
	{
		...
		//是否均衡
		boolean balanced = runeComponent.getLevel(IWEnchantments.ENTRY_BALANCE) > 0;
		boolean firstUp = true;
		//是否强化
		boolean boost = runeComponent.getLevel(IWEnchantments.ENTRY_RUNE_BOOST) > 0;
		//获得最大附魔数
		int maxEnchantCount = getGeneratorEntryCount(runeComponent.getLevel(IWEnchantments.ENTRY_LUCKY),
