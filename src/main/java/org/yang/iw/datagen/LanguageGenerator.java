...
import org.yang.iw.rune_ability.*;
import org.yang.iw.rune_upgrade.HeavyUpgrade;
...
public class LanguageGenerator extends FabricLanguageProvider
{
									 ...
									 TranslationBuilder translationBuilder)
	{
		...
		translationBuilder.add("enchantment.iw.fast_hit", "迅捷打击");
		translationBuilder.add("enchantment.iw.balance", "均衡");
		translationBuilder.add("enchantment.iw.plentiful", "充盈");
		translationBuilder.add("enchantment.iw.rune_boost", "符文强化");
		translationBuilder.add("enchantment.iw.energy_efficiency", "聚能");
		translationBuilder.add("enchantment.iw.lucky", "幸运");
		translationBuilder.add("enchantment.iw.fast_attack", "快速挥舞");
		...
		translationBuilder.add("item.iw.enchantedheart", "附魔之心");
		translationBuilder.add(IWItems.TINKER_HEART, "工匠之心");
		try
		{
			Path existingFilePath = generator.getModContainer().findPath("assets/iw/lang/zh_cn.json")
					.get();
