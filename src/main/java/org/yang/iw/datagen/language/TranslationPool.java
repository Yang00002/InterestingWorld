...
public class TranslationPool
{
	...
	{
		if (providers != null) providers.forEach(translationBuilder::add);
	}
	...
	public static String add(String ori, String trans)
	{
		if (providers != null) providers.put(ori, trans);
		return ori;
	}
	...
	public static final String FORGING_BLOCK_TITLE_ALL_N = add("forgingblock.title.all", "修复、强化、升级和能力修改");
	public static final String FORGING_BLOCK_TITLE_PREENCHANT_N = add("forgingblock.title.preenchant", "强化附加");
	public static final String FORGING_BLOCK_TIP_PREENCHANT_N = add("forgingblock.text.preenchant.2",
			"放入工具以指示转换的目标强化种类");
	public static final String FORGING_BLOCK_TITLE_ENCHANT_N = add("forgingblock.title.enchant", "强化");
	public static final String FORGING_BLOCK_TIP_CANNOT_USE_BECAUSE_LEVEL_N = add("forgingblock.text.level",
			"你还不能使用该符文");
	public static final String FORGING_BLOCK_TIP_ENCHANT_COST_L_N = add("forgingblock.text.enchant.3xpl", "强化花费：");
	...
	public static final String FORGING_BLOCK_TIP_BOOST_TIME_LACK = add("forgingblock.text.abilityremove.22",
			"强化次数不足");
